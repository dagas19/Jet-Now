...
jet1 = Jet.create(model: "Grumman Gulfstream II", max_speed: 501, max_range: 2000, fuel_consumption: 50, description: "set up with horizontal sleeping positions and shower", price_hourly: 5000, user: user1,location: "London", passenger_capacity: 12)
...
jet3 = Jet.create(model: "Global 7500", max_speed: 500, max_range: 2400, fuel_consumption: 70, description: "set up with snooker table", price_hourly: 7000, user: user3,location: "Rome", passenger_capacity: 8)
jet4 = Jet.create(model: "Cessna Citation Longitude", max_speed: 550, max_range: 4000, fuel_consumption: 90, description: "comes with Michel star chef", price_hourly: 8000, user: user3,location: "Istanbul", passenger_capacity: 4)
jet5 = Jet.create(model: "Pilatus PC-24", max_speed: 590, max_range: 4200, fuel_consumption: 35, description: "set up for yoga studio", price_hourly: 2900, user: user3,location: "Dubai", passenger_capacity: 15)
jet6 = Jet.create(model: "Gulfstream G600", max_speed: 700, max_range: 3000, fuel_consumption: 70, description: "includes gym and sauna", price_hourly: 4200, user: user7,location: "Los Angeles", passenger_capacity: 20)
jet7 = Jet.create(model: "Dassault Falcon 6X", max_speed: 740, max_range: 3400, fuel_consumption: 55, description: "includes music recording studio", price_hourly: 6200, user: user8,location: "Frankfurt", passenger_capacity: 17)
jet8 = Jet.create(model: "Phenom 100V+", max_speed: 680, max_range: 3600, fuel_consumption: 40, description: "includes DJ, bar and bouncer", price_hourly: 5200, user: user7,location: "Lisbon", passenger_capacity: 15)
jet9 = Jet.create(model: "Embraer Legacy 700", max_speed: 640, max_range: 5400, fuel_consumption: 39, description: "includes playstation 4 and xbox", price_hourly: 6200, user: user15,location: "Buenos Aires", passenger_capacity: 8)
jet10 = Jet.create(model: "Dassault Falcon 50", max_speed: 620, max_range: 4400, fuel_consumption: 52, description: "includes access to private villa in Portugal", price_hourly: 7200, user: user3,location: "Bogota", passenger_capacity: 7)
jet11 = Jet.create(model: "Cirrus Vision SF50", max_speed: 510, max_range: 4100, fuel_consumption: 58, description: "provided with unlimited beer and wine", price_hourly: 9200, user: user12,location: "Vancouver", passenger_capacity: 4)
jet12 = Jet.create(model: "Cessna Citation X", max_speed: 490, max_range: 4900, fuel_consumption: 59, description: "features exhibition gallery of fine art", price_hourly: 6200, user: user11,location: "Ho Chi Minh City", passenger_capacity: 3)
jet13 = Jet.create(model: "Embraer Legacy 600", max_speed: 515, max_range: 4010, fuel_consumption: 65, description: "set up for dinner party", price_hourly: 4200, user: user10,location: "Shanghai", passenger_capacity: 2)
jet14 = Jet.create(model: "Cessna Citation Columbus", max_speed: 700, max_range: 2400, fuel_consumption: 70, description: "dog-friendly", price_hourly: 3200, user: user1,location: "Moscow", passenger_capacity: 9)
jet15 = Jet.create(model: "Aerion AS2", max_speed: 710, max_range: 5000, fuel_consumption: 65, description: "cat-friendly", price_hourly: 6200, user: user1,location: "Ankara", passenger_capacity: 10)
jet16 = Jet.create(model: "Dassault Falcon 900LX", max_speed: 754, max_range: 4800, fuel_consumption: 80, description: "capable of taking 500kg of luggage", price_hourly: 5200, user: user4,location: "Johanesberg", passenger_capacity: 11)
jet17 = Jet.create(model: "SyberJet SJ30i", max_speed: 654, max_range: 2900, fuel_consumption: 75, description: "able to take-off/land on runways only 400m", price_hourly: 6200, user: user6,location: "Tiplisi", passenger_capacity: 14)
jet18 = Jet.create(model: "Cessna Citation CJ3+/4", max_speed: 667, max_range: 3400, fuel_consumption: 85, description: "only available for 14 day bookings", price_hourly: 4200, user: user6,location: "Tallinn", passenger_capacity: 16)
jet19 = Jet.create(model: "Embraer Legacy 450", max_speed: 690, max_range: 4400, fuel_consumption: 51, description: "set-up for ball-room dancing", price_hourly: 7200, user: user7,location: "Cairo", passenger_capacity: 11)
jet20 = Jet.create(model: "Embraer Legacy 500", max_speed: 785, max_range: 6400, fuel_consumption: 48, description: "includes mini-golf", price_hourly: 8200, user: user3,location: "Manchester", passenger_capacity: 5)
jet21 = Jet.create(model: "HondaJet Elite", max_speed: 900, max_range: 4400, fuel_consumption: 70, description: "set up as a casino", price_hourly: 8300, user: user1,location: "Adis Ababa", passenger_capacity: 6)
...
jet28 = Jet.create(model: "Dassault Falcon 6X", max_speed: 740, max_range: 3400, fuel_consumption: 55, description: "includes music recording studio", price_hourly: 6200, user: user9,location: "Frankfurt", passenger_capacity: 12)
