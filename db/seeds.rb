...
jet6 = Jet.create(model: "Gulfstream G600", max_speed: 700, max_range: 3000, fuel_consumption: 70, description: "includes gym and sauna", price_hourly: 4200, user: user17,location: "Los Angeles", passenger_capacity: 20)
jet7 = Jet.create(model: "Dassault Falcon 6X", max_speed: 740, max_range: 3400, fuel_consumption: 55, description: "includes music recording studio", price_hourly: 6200, user: user18,location: "Frankfurt", passenger_capacity: 17)
jet8 = Jet.create(model: "Phenom 100V+", max_speed: 680, max_range: 3600, fuel_consumption: 40, description: "includes DJ, bar and bouncer", price_hourly: 5200, user: user17,location: "Lisbon", passenger_capacity: 15)
...
jet44 = Jet.create(model: "Global 7500", max_speed: 500, max_range: 2400, fuel_consumption: 70, description: "set up with snooker table", price_hourly: 7000, user: user17,location: "Cairo", passenger_capacity: 19)
jet45 = Jet.create(model: "Cessna Citation Longitude", max_speed: 550, max_range: 4000, fuel_consumption: 90, description: "comes with Michel star chef", price_hourly: 8, location: "Beirut", passenger_capacity: 12, user: user18)
jet46 = Jet.create(model: "Pilatus PC-24", max_speed: 590, max_range: 4200, fuel_consumption: 35, description: "set up for yoga studio", price_hourly: 2900, user: user16,location: "Ankara", passenger_capacity: 12)
...
jet59 = Jet.create(model: "Cessna Citation CJ3+/4", max_speed: 667, max_range: 3400, fuel_consumption: 85, description: "only available for 14 day bookings", price_hourly: 4200, user: user18,location: "Oslo", passenger_capacity: 16)
